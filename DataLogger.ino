...
volatile boolean triggered =
    false;  ///< Flag indicating whether a timer interrupt occurred
 ...
 */
ISR(TIMER1_COMPA_vect) { triggered = true; }
 ...
 */
void displayline(const float measurment, const uint8_t line_num,
                 const char line_end[]) {
  char floatbuf[16] = {0};
